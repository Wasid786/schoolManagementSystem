...
func (app *application) createAuthenticationTokenHandler(w http.ResponseWriter, r *http.Request) {
	...
	student, err := app.models.Students.GetByEmail(input.Email)
	if err != nil {
		switch {
	...
	match, err := student.Password.Matches(input.Password)
	if err != nil {
		app.serverErrorResponse(w, r, err)
		return
	}
	...
	claims.Subject = strconv.FormatInt(int64(student.ID), 10)
...
func (app *application) createPasswordResetTokenHandler(w http.ResponseWriter, r *http.Request) {
	...
	// token, err := app.models.Tokens.New(student.ID, 45*time.Minute, data.ScopePasswordReset)
	token, err := app.models.Tokens.New(int64(student.ID), 45*time.Minute, data.ScopePasswordReset)
	if err != nil {
		app.serverErrorResponse(w, r, err)
		return
	}
	app.background(func() {
		...
		err = app.mailer.Send(student.Email, "token_password_reset.tmpl", data)
		if err != nil {
...
func (app *application) createActivationTokenHandler(w http.ResponseWriter, r *http.Request) {
	...
	app.background(func() {
		...
		err = app.mailer.Send(student.Email, "token_activation.tmpl", data)
		if err != nil {
			app.logger.PrintError(err, nil)
		}
	})
